                    ...
                    <div class="table-responsive" style="overflow-x:hidden;">
                        ...
                        <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="alamat" id="alamat" class="form-control <?= form_error('alamat') ? 'invalid':'' ?>" value="<?= form_error('alamat') ? set_value('alamat') : $current_user->alamat ?>" placeholder="Wajib Di isi...." disabled></textarea>
                            </div>
                            <div class="invalid-feedback">
                                <?= form_error('alamat')?>
                            </div>
